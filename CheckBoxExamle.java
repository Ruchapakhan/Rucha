...
//		checkbox1.click();
		...
		//to click the checkbox is already selected or not we need to use below logic
...
//		}
		...
		//if you have multiple element and you want to perform operation on specific index you 
...
//		}
		...
		for(int i=0;i<size;i++) 
		{
			//getattribute method is used to fetch the value of element attribute as per given key
